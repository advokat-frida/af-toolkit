...
const heightPost = `(function(){
  ...
  function report(){var h=Math.ceil(article?document.body.getBoundingClientRect().height:document.documentElement.getBoundingClientRect().height);if(h&&h!==last){last=h;try{window.parent.postMessage({type:'af-objection-oracle-resize',height:h},'*');}catch(error){}}}
