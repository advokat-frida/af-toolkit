...
import { isSafeColumnName } from "./generate.js";
...
export function validateRunRecord(value) {
    ...
    if (typeof value.rowCount !== "number" ||
    ...
    if (!Array.isArray(columns) || columns.some((column) => typeof column !== "string")) {
        ...
        if (columns.some((column) => typeof column === "string" && SINGLE_LINE.test(column) && !isSafeColumnName(column))) {
