...
export async function runStaticChecks() {
  ...
  results.push(check(index.includes('<h1 id="home-title" tabindex="-1">The Advokat Frida Toolkit</h1>'), "Home nameplate is the approved The Advokat Frida Toolkit (Ben, 2026-09-04)"));
  results.push(check(index.includes(`<p class="home-lede">A privacy practitioner's Swiss Army knife.</p>`), "Home lede uses the approved practitioner promise (Ben, 2026-09-04)"));
